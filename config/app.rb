...
Volt.configure do |config|
  ...
  #######################################
  config.domain = 'apollo.com'
  config.app_name = 'Apollo'
  config.mailer.from = 'Apollo <no-reply@apollo.com>'
  ...
  #
  config.app_secret = 'HEVhTqOTYlPdgc_7SDMNMXJdpO7NwiM2EEp5VJH_hjLfLynejwDvDu3PEOOPSWHzw1I'
